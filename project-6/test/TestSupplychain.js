...
contract('SupplyChain', function(accounts) {
    ...
    // 3rd Test
    it.only("Testing smart contract function packItem() that allows a farmer to pack coffee", async() => {
        const supplyChain = await SupplyChain.deployed()
        await supplyChain.addFarmer(originFarmerID, {from: ownerID});
        ...
        // Pack the item
        let packTx = await supplyChain.packItem(upc, {from: originFarmerID});
